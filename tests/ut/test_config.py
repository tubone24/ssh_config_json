...
class TestSSHConfig:
    ...
    def test_create_ssh_config_str_ok(self):
        target = SSHConfig("tests/assets/test_config")
        target._config = [
            {},
            {
        ...
        actual = target.create_ssh_config_str(False)
        expected = """Host test1Server
    HostName test1.example.com
    IdentityFile tests/assets/test1.pem
    Port 22
    User testuser
...
Match exec "networksetup -getairportnetwork en0 | grep -q '<SSID>'"
    ...
    def test_create_ssh_config_str_ok_no_identity_key_with_restore(self):
        target = SSHConfig("tests/assets/test_config")
        target._config = [
            {},
            {
        ...
        actual = target.create_ssh_config_str(True)
        expected = """Host test1Server
    HostName test1.example.com
    IdentityFile tests/assets/test1.pem
    Port 22
...
Match exec "networksetup -getairportnetwork en0 | grep -q '<SSID>'"
    ...
    def test_create_ssh_config_str_ok_identity_key(self):
        target = SSHConfig("tests/assets/test_config")
        target._config = [
            {},
            {
...
Match exec "networksetup -getairportnetwork en0 | grep -q '<SSID>'"
    ...
    def test_create_ssh_config_str_ok_identity_key_with_restore_key(self):
        target = SSHConfig("tests/assets/test_config")
        target._config = [
            {},
            {
